...
class Memory:
    ...
    def update_usage_vector(usage_vector, read_weightings, write_weighting, free_gates):
        ...
        retention_vector = tf.reduce_prod(input_tensor=1 - read_weightings * free_gates, axis=2)
    ...
    def get_allocation_weighting(self, sorted_usage, free_list):
        ...
        shifted_cumprod = tf.math.cumprod(sorted_usage, axis=1, exclusive=True)
        ...
        stacked_weightings = flat_ordered_weightings.stack()
        return tf.reshape(stacked_weightings, (self.batch_size, self.words_num))
    ...
    def update_precedence_vector(precedence_vector, write_weighting):
        ...
        reset_factor = 1 - tf.reduce_sum(input_tensor=write_weighting, axis=1, keepdims=True)
